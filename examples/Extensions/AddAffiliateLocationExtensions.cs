...
using static Google.Ads.GoogleAds.V5.Enums.AffiliateLocationFeedRelationshipTypeEnum.Types;
using static Google.Ads.GoogleAds.V5.Enums.AffiliateLocationPlaceholderFieldEnum.Types;
